...
const CALENDLY_URL = 'https://calendly.com/jude-hyperionlabs/discovery-call'
...
function CalendlyWidget() {
  return (
    <div
      ...
      style={{ minWidth: '320px', height: '700px', border: '1px solid rgba(0,212,255,0.2)', borderRadius: '16px' }}
    />
  )
}
